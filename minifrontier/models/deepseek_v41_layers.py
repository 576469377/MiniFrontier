"""Differentiable CSA2 and Single-Pass mHC from DeepSeek-V4.1 dba1be0.

Reference: inference/model.py (Attention, Indexer, Compressor, Block), MIT.
...
from minifrontier.models.minideepseekv4.upstream_layers import RMSNorm
...
def single_pass_coefficients(
    ...
    *,
    ...
    """Shared FP32 coefficient projection and the official Sinkhorn split."""
