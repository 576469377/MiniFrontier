# MF-owned image resize and Conv3D frame packing; no cross-model imports.
# smart_resize: Transformers/Qwen 4177486a9f199bd7be520eff14431071d5d41ec5 (Apache-2.0).
# Frame adapter copied from MiniFrontier miniqwen4/processing.py without mathematical changes.
# Only the resize and frame-packing closure is retained; MF supplies its own token positions.
# mypy: ignore-errors
# ruff: noqa
